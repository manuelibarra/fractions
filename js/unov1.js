...
var unoUno={
    create: function() {  
        ...
        for(var p=0;p<this.numit;p++){
            ...
            if(img==1){
                var fracc = game.add.sprite(60, 485-p*80, 'full');
                fracc.anchor.setTo(0.5, 0.5);
                this.blocks.add(fracc);
                this.finalpos += 260;
                this.bindex.push(260);
            }else{
                var fracc = game.add.sprite(60, 485-p*80, 'half');
                fracc.anchor.setTo(0.5, 0.5);
                this.blocks.add(fracc);
                this.finalpos += 130;
        ...
        //niño
        this.kid = game.add.sprite(66, 460-this.numit*80, 'kid'); //cargamos sprite niño
